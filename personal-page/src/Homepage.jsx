...
export default function Homepage() {
    ...
    return (
        <div 
            className="relative h-screen overflow-hidden text-slate-900 font-sans overscroll-none"
            style={{ backgroundColor: colors.background, color: colors.textDefault }}
        >
            ...
            <Paper elevation={3} className="p-8 rounded-lg" style={{ backgroundColor: colors.paperBg }}>
                ...
                <main className="w-full px-6 md:px-12 lg:px-24 py-20 z-10 relative flex flex-col items-start min-h-screen">
